...
pub fn device_events(rx: Receiver<InputEvent>, frame: (u32, u32, u32, u32, u32, u32)) -> Receiver<DeviceEvent> {
    let (ty, ry) = mpsc::channel();
    thread::spawn(move || CURRENT_DEVICE.parse_device_events(&rx, &ty, frame));
    ry
}
